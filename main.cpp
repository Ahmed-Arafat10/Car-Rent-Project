...
//}
    ...
    bool is_no_of_each_car_exist(int no) {
                ...
                if (is_exist) {
                    ...
                    if (customer_choise == 1) {
                        ...
                        if (Customer_list[nooo].cars_rented() >= 2) {
                            cout << "Sorry " << Customer_list[nooo].customer_name_getter()
                                 << " you can't rent any other car as you already rented 2 cars at the same time"
                                 << endl << endl;

                        } else if (C[wanted_car - 1].is_choosen_car_rented()) {

                            cout << "Sorry you can't rent this car as it's already rented to someone else" << endl
                                 << endl;
                            ...
                            while (true) {
                                if (days > 30) {
                                    cout << "Sorry " << days
                                         << " days is to much, we can't agree upon this number of days" << endl;
                                    cout << "please enter another number of days" << endl;
                                    cin >> days;
                                } else {
                                    cout << "Total money you will pay to rent the car for " << days << " days is : "
                                         << days * C[wanted_car - 1].rent_per_day_getter() << " L.E." << endl;
                                    cout << "Are you sure that you want to complete the transaction ?" << endl;
                                    cout << "[Y/N]" << endl;
                                    char c;
                                    cin >> c;
                                    if (c == 'Y') {
                                        cout << "Congratulations .. The rent transaction is completed successfully"
                                             << endl << endl;
                                        C[wanted_car - 1].become_rented();
                                        Customer_list[nooo].add_car_to_rent(wanted_car - 1);
                                        C[wanted_car - 1].save_name(Customer_list[nooo].customer_name_getter(),
                                                                    wanted_car - 1);
                                        break;
                                    }
                                    if (c == 'N') {
                        ...
                        } else cout << "Please enter a right number range between 1 to 10" << endl << endl;

                    } else if (customer_choise == 2) {
                        Customer_list[nooo].no_of_each_car_getter();
                        cout << "please enter number of car you want to return" << endl << endl;
                        int car_no;
                        cin >> car_no;
                        if (Customer_list[nooo].is_no_of_each_car_exist(car_no) && car_no != 0) {
